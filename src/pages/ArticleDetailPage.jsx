        ...
        >
          ...
          {lang === 'zh' && localizedArticle.id === 1 ? (
            ...
            <article className="prose prose-invert max-w-none">
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                Grove City College is not a top-rank school, but its academic rigor and social environment are among the best. It is a Christian university that requires students' participation in church services with a strong emphasis on humanities education. Overall, it is a premier place to study Austrian economics.
              </p>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                The London School of Economics is possibly the best research university in Europe to study Economics. It is located in London, which is one of the largest financial centers, providing excellent educational and employment opportunities for London students. The prominent Austrian economist Frederick Hayek was a Professor of Economics at LSE for around twenty years, and there are still faculty members upholding Hayek's philosophy at LSE STICERD (It has a Hayek Program in Economics and Liberal Political Economy). LSE has invited leading Austrians to lecture at the university, including Professor Peter J Boettke and Professor Christopher Coyne. LSE's economics program is possibly the most competitive for prospective students. LSE is, therefore, an excellent school for students determined to receive rigorous technical training as well as some exposure to Austrian economics.
              </p>
